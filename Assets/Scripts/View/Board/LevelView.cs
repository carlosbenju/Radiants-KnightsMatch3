...
public class LevelView : MonoBehaviour
{
    ...
    [SerializeField] GameWonPopupView _gameWonPopupPrefab;
    [SerializeField] GameObject _gameLostPopupPrefab;
    ...
    void OpenWinPopup()
    {
        Instantiate(_gameWonPopupPrefab).Initialize(_levelController.Level);
    }

    void OpenLosePopup()
    {
        Instantiate(_gameLostPopupPrefab);
    }
